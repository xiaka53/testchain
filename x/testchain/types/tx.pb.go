...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "xiaka53.testchain.testchain.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "xiaka53.testchain.testchain.MsgCreatePostResponse")
}
...
var fileDescriptor_e7cc6edd17846f94 = []byte{
	...
	0xae, 0xc8, 0x4c, 0xcc, 0x4e, 0x34, 0x35, 0xd6, 0x83, 0xcb, 0x21, 0x58, 0x4a, 0xc1, 0x5c, 0xbc,
	...
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xiaka53.testchain.testchain.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xiaka53.testchain.testchain.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xiaka53.testchain.testchain.Msg",
